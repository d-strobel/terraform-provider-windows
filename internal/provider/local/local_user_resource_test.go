	...
	resource.Test(t, resource.TestCase{
        ...
        `,
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("windows_local_user.test_1", "password_required", "false"),
			...
			// Create and Read testing with name + password
			{
			  ...
			  `,
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("windows_local_user.test_2", "password_required", "false"),
			...
			// Create and Read testing with all possible parameters
			{
			  ...
			  `,
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("windows_local_user.test_3", "password_required", "false"),
